...
//
//
//// В контексте банковского проекта паттерн "Команда" может быть использован для определения и
//// выполнения различных операций, таких как перевод средств и их отмена.
//
//// Интерфейс команды
//interface Command {
//    void execute();
...
//}
//
////Паттерн "Команда" помогает структурировать выполнение операций в банковской системе, обеспечивая возможность
//// легко добавлять новые функции и отменять операции. Это улучшает читаемость и поддерживаемость кода,
//// позволяя удобно управлять действиями пользователя.
//
